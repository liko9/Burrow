...
type KafkaAdminClient struct {
	...
	cluster               string
	servers               []string
// Following aren't needed with the AdminClient
//	offsetsTopic          string
//	startLatest           bool
...
//func (module *KafkaAdminClient) startBackfillPartitionConsumer(partition int32, client helpers.SaramaClient, consumer sarama.Consumer) error {
...
//func (module *KafkaAdminClient) startKafkaConsumer(client helpers.SaramaClient) error {
